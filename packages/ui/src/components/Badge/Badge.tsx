  ...
  'border-border inline-flex items-center justify-center border-(length:--border-width) whitespace-nowrap',
  {
    ...
    compoundVariants: [
      ...
      },
      {
        variant: 'pill',
        color: 'green',
        className: 'bg-accent-green text-accent-foreground',
      },
      {
        variant: 'pill',
        color: 'cyan',
        className: 'bg-accent-cyan text-accent-foreground',
      },
      {
        variant: 'pill',
        color: 'orange',
        className: 'bg-accent-orange text-accent-foreground',
      },
      {
        variant: 'pill',
        color: 'red',
        className: 'bg-accent-red text-accent-foreground',
      },
      {
        variant: 'pill',
        color: 'yellow',
        className: 'bg-accent-yellow text-accent-foreground',
      },
      {
        variant: 'pill',
        color: 'purple',
        className: 'bg-accent-purple text-accent-foreground',
      },
      {
        variant: 'pill',
        color: 'blue',
        className: 'bg-accent-blue text-accent-foreground',
      },
    ],
    defaultVariants: {
      variant: 'dot',
