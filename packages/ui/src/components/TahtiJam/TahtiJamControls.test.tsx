...
import { TahtiJamControls } from './TahtiJamControls';
...
describe('TahtiJamControls', () => {
  it('(Snapshot) renders the controls', () => {
    const { container } = render(<TahtiJamControls {...baseProps} />);
    expect(container).toMatchSnapshot();
  });

  it('shows elapsed time and remaining time counting down', () => {
    render(<TahtiJamControls {...baseProps} />);
  ...
  it('shows the play button when paused', () => {
    render(<TahtiJamControls {...baseProps} isPlaying={false} />);
  ...
  it('shows the pause button when playing', () => {
    render(<TahtiJamControls {...baseProps} isPlaying={true} />);
