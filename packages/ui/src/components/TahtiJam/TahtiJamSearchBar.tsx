...
export type TahtiJamSearchBarLabels = {
  placeholder: string;
};

export type TahtiJamSearchBarProps = {
  value: string;
  onChange: (value: string) => void;
  labels: TahtiJamSearchBarLabels;
  className?: string;
};

export const TahtiJamSearchBar: FC<TahtiJamSearchBarProps> = ({
  value,
  onChange,
  labels,
  className,
