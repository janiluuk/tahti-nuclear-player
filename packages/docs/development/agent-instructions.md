...
{% hint style="info" %}
This page mirrors the root [`AGENTS.md`](https://github.com/nukeop/nuclear/blob/master/AGENTS.md) file for browsing here. Agent tooling (Claude Code, etc.) auto-discovers instructions from that exact root-level file, not from this page — if you're updating agent behavior, edit `AGENTS.md` and re-sync this page, not the other way around.
{% endhint %}
