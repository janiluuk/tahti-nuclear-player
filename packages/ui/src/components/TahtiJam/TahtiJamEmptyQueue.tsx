...
export type TahtiJamEmptyQueueLabels = {
  title?: string;
  subtitle?: string;
};

type TahtiJamEmptyQueueProps = {
  labels: TahtiJamEmptyQueueLabels;
  className?: string;
};

export const TahtiJamEmptyQueue: FC<TahtiJamEmptyQueueProps> = ({
  labels,
  className,
}) => (
  <div
