---
description: Guidelines AI coding agents follow when working on this codebase
---

# Agent instructions

{% hint style="info" %}
This page mirrors the root [`AGENTS.md`](https://github.com/janiluuk/tahti-player/blob/master/AGENTS.md). Agent tooling auto-discovers that file. GitHub Copilot also reads [`.github/copilot-instructions.md`](https://github.com/janiluuk/tahti-player/blob/master/.github/copilot-instructions.md), which points at `AGENTS.md` rather than duplicating it. Edit `AGENTS.md` and re-sync this page — not the other way around.
{% endhint %}
