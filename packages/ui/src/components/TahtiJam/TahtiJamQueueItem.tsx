...
import { pickArtwork, QueueItem } from '@tahti-player/model';
...
export const TahtiJamQueueItem = forwardRef<
  HTMLDivElement,
  TahtiJamQueueItemProps
...
TahtiJamQueueItem.displayName = 'TahtiJamQueueItem';
