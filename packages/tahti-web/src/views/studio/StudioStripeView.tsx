          ...
          <>
            {connect ? (
              ...
              >
                ...
                >
                  <StatusPill ok={connect.stripeConfigured} label="Stripe on" />
                  <StatusPill
                ...
                >
                  ...
                  {connect.accountId ? (
                    <Button
                      size="sm"
                      variant={connect.paymentsReady ? undefined : 'secondary'}
                      onClick={() => {
            ...
            <p className="text-foreground-secondary text-xs">
              Express dashboard payouts to your bank follow Stripe’s schedule. A
              paid order here means Tahti booked the period.{' '}
              <Link
                to="/studio/revenue"
